...
* [Halting]() - обычное выключение (как на любом компьютере),
* [Destroing]() - выключение с очисткой места на диске, которое занимало запущенное виртуальное окружение.
 Все эти типы завершения работы рассмотрены далее.
