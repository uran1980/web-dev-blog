...
Для этих целей **Vagrant** позволяет использовать на выбор одно из двух решений для развертывания приложений - это **[Chef (Chef-Solo)](http://docs.vagrantup.com/v1/docs/provisioners/chef_solo.html)** или **[Puppet](http://docs.vagrantup.com/v1/docs/provisioners/puppet.html)**. Также, при необходимости, вы можете расширять **Vagrant** и использовать **[другие средства](http://docs.vagrantup.com/v1/docs/provisioners/puppet.html)** автоматизации развертывания приложение (но это уже не относится к теме данной статьи).
