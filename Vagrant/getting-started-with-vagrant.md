...
### Установка Vagrant
Чтобы установить **Vagrant**, необходимо скачать соответствующий пакет или установщик с **[этой страницы загрузки](http://downloads.vagrantup.com/)** и установить его, используя стандартную процедуру установки приложения на вашей системе. В операционных систмах **Windows** и **Mac OS X** после установки автоматически будет доступна из командной строки команда `Vagrant`. На остальных систмах вам необходимо самим добавить этот путь `/opt/vagrant/bin` в переменную окружения `PATH`.
