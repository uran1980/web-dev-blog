...
## Начало
Фактически Vagrant является надстройкой над программой **[VirtualBox](http://www.virtualbox.org/)** от Oracle, обеспечивающей создание и настройку виртуальных машин. Созданные таким образом виртуальные машины - боксы (boxes) используются разработчиками web-приложений для построения необходимой среды разработки. Эти виртуальные боксы, затем могут быть упаокованы в специальные контейнеры, для установки и использования другими разработчиками в команде.
