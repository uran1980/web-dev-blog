...
## Проверяем rewrite'ы
Не считайте себя гуру в написании регулярных выражений, в любом случае вы ошибетесь и не заметите этого. В сложном регулярном выражении нельзя быть уверенным на сто процентов, что он работает, поэтому самое простое это исключить такие выражения из использования в пользу более чистого и понятного кода. Вот пример:
...
```
Посмотрети, на первый вариант, потом на последний, потом опять на первый и опять на последний. Ну что?
